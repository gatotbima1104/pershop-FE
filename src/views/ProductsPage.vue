...
<template>
  <div class="flex h-screen">
    ...
    <div class="h-full w-full bg-slate-100 overflow-y-auto">
      <Navbar title="Restock and Manage your product here !!" />
      <div
        class="border bg-slate-200 h-full flex items-center justify-center"
      >
            ...
            <table class="mt-5 w-full">
              ...
              <tbody>
                <tr v-for="(product, index) in store.products" :key="index">
                  ...
                  <td class="border px-4 py-2">{{ product.stock }} pcs</td>
